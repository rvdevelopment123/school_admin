...
export default {
  ...
  created() {
    ...
    this.filterAll = this.$route.query.searchfilters;
  ...
  methods: {
    ...
    clone(item) {
      try {
        this.$store.commit("demo", "unable to clone/copy", { root: true });
      } catch (e) { return e; }
      const vm = this
      if (!item) { return }
    ...
    async deleteConfirmed(id) {
      try {
        this.$store.commit("demo", "unable to delete", { root: true });
      } catch (e) { return e; }
      try {
